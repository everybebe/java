...
public class MemberController {
	...
	private void updeteMember2() {
		...
		System.out.println();
		System.out.print("새로운 " + updateFieldTitle + "데이터 >> ");
	...
	private void updeteMember3() {
		...
		if(dataMap.size()==0) {
			System.out.println("수정할 내용은 하나도 선택하지 않았습니다.");
			System.out.println("수정 작업을 마칩니다.");
			return;
		}
	...
	private void deleteMember() {
		...
		int cnt = service.deleteMember(id); //서비스로 명령어를 호출
	...
	private void insertMember() {
		...
		//Service의 insertMemeber()메소드를 호출해서 실행한다.
	...
	private int displayMenu() {
		...
		System.out.println(" 3. 자료수정1 (전체 항목 수정)");
		System.out.println(" 4. 전 체 자 료 출 력");
		System.out.println(" 5. 자료수정2 (수정 항목 선택)");
		System.out.println(" 6. 자료수정3 (입력 항목만 수정)");
